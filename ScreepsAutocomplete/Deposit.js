 ...
 * room operation triggers a cooldown period, which becomes longer and longer over time.
 *
 * @class
 * @extends {RoomObject}
 *
...
Deposit.prototype = {
    ...
    /**
     * The amount of game ticks until the next room action is possible.
     *
    ...
    /**
     * The cooldown of the last room operation on this deposit.
     *
